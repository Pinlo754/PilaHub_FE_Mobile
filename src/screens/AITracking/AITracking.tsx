...
export default function AITracking({ onFeedback }: Props) {
        ...
        async (data: any) => {
            ...
            try {
                ...
                const covertNametoId = (name: string) => {
                    if (name === 'Spine Stretch Forward') return '02721a7d-9a25-4712-8048-d99043d4fb38';
                    return '';
                }
