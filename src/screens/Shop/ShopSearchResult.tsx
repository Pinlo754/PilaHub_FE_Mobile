...
export default function ShopSearchResult() {
 ...
 const styles = StyleSheet.create({
   ...
   headerSearch: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 6, borderRadius: 10, borderWidth: 1, borderColor: '#F3F4F6' },
   headerSearchInput: { flex: 1, marginLeft: 8, paddingVertical: 2 },
