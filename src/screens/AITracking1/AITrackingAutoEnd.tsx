...
//         } catch (err) {
//           console.warn('HR sampling error', err);
//         }
...
//         {showCamera ? (
//           workoutSession && workoutSession.haveAITracking ? (
//             <RNMediapipe
//               style={{ flex: 1 }}
//               onLandmark={data => {
...
const AITrackingAutoEnd = () => {
  return (
    <View>
      <Text>AITrackingAutoEnd</Text>
    </View>
  );
};

export default AITrackingAutoEnd;
